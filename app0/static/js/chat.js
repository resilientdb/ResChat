const receiver_nickname = JSON.parse(document.getElementById('json-username').textContent);
const message_username = JSON.parse(document.getElementById('json-message-username').textContent);

console.log(receiver_nickname);  // Should output: keny
console.log(message_username);   // Should output: bella

// establish a WebSocket connection to ws://127.0.0.1:8000/ws/kny/
